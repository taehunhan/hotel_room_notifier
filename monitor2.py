...
STATE_FILE = os.environ.get("STATE_FILE", "state2.json")
SITES_FILE = os.environ.get("SITES_FILE", "site2.json")
...
ROOM_TYPE = [
    "스탠다드 레이크뷰 (Standard Lake View)", 
    "수페리어 - 퀸침대 2개 (Superior 2 Queen Beds)",
    "가든 뷰 - 킹침대 (Garden View King Bed)",
    "슈페리어 킹베드 레이크뷰 (Superior King Bed Lake View)",
    "스탠다드 2 더블 가든뷰 (Standard 2 Double Garden View)"
]
